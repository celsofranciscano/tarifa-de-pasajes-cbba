...
-- CreateTable
CREATE TABLE "tbdetailspassenger" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME,
    CONSTRAINT "tbdetailspassenger_FK_passenger_fkey" FOREIGN KEY ("FK_passenger") REFERENCES "tbpassenger" ("PK_passenger") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE UNIQUE INDEX "tbdetailspassenger_FK_passenger_key" ON "tbdetailspassenger"("FK_passenger");

-- CreateIndex
CREATE UNIQUE INDEX "tbdetailspassenger_email_key" ON "tbdetailspassenger"("email");
