...
function MonthlyExtrasChart() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("/api/dashboard/income/extras/report");
...
export default MonthlyExtrasChart;
