...
function MonthlyOperationalChart() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("/api/dashboard/expenses/extras/report");
  ...
  return (
    <div className=" p-4 shadow-md rounded-md">
      <h1 className="text-xl font-semibold mb-4 text-black ">
        Egresos Mensuales para Operaciones
      </h1>
...
export default MonthlyOperationalChart;
