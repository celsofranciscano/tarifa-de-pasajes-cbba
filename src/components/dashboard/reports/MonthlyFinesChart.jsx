...
function MonthlyFinesChart() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get("/api/dashboard/income/fines/report");
  ...
  return (
    <div className=" p-4 shadow-md rounded-md">
      <h1 className="text-xl font-semibold mb-4 text-black ">
        Ingresos Mensuales Multas y retrasos
      </h1>
...
export default MonthlyFinesChart;
